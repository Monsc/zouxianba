...
- Name: 社交核心功能自动化测试 >> 未注册邮箱登录应提示“该邮箱未注册”
- Location: C:\Users\Main\Desktop\zxb\core-flow.spec.ts:8:7
...
Locator: locator('text=该邮箱未注册')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('text=该邮箱未注册')

    at C:\Users\Main\Desktop\zxb\core-flow.spec.ts:13:47
```
...
- paragraph:
  ...
  - link "立即注册":
    - /url: /register
- text: 邮箱地址
- textbox "邮箱地址": notexist@example.com
- text: 密码
- textbox "密码": "123456"
- checkbox "记住我"
- text: 记住我
