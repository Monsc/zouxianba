...
- Name: 社交核心功能自动化测试 >> 已注册邮箱+错误密码登录应提示“密码错误”
- Location: C:\Users\Main\Desktop\zxb\core-flow.spec.ts:16:7
...
Locator: locator('text=密码错误')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('text=密码错误')

    at C:\Users\Main\Desktop\zxb\core-flow.spec.ts:21:45
```
