...
- Name: 社交核心功能自动化测试 >> 用户2登录并评论、点赞用户1的帖子
- Location: C:\Users\Main\Desktop\zxb\core-flow.spec.ts:47:7
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at C:\Users\Main\Desktop\zxb\core-flow.spec.ts:52:24
```
...
- paragraph:
  ...
  - link "立即注册":
    - /url: /register
- text: 邮箱地址
- textbox "邮箱地址": test2@example.com
- text: 密码
