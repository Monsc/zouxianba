...
import { UserService, UserSettings as UserSettingsType } from '@/services/UserService';
...
export const UserSettings: React.FC = () => {
  ...
  // 更新设置
  const handleUpdateSettings = async (updates: Partial<UserSettingsType>) => {
    if (!settings) return;
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <Select
                ...
                onChange={(value) =>
                  handleUpdateSettings({ language: value as 'zh' | 'en' })
                }
                options={[
                  { value: 'zh', label: '中文' },
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              <Switch
                label="新关注"
                checked={settings.notificationSettings.follow}
                onChange={(checked) =>
                  handleUpdateSettings({
                    notificationSettings: {
                      ...settings.notificationSettings,
              ...
              <Switch
                label="新点赞"
                checked={settings.notificationSettings.like}
                onChange={(checked) =>
                  handleUpdateSettings({
                    notificationSettings: {
                      ...settings.notificationSettings,
              ...
              <Switch
                label="新评论"
                checked={settings.notificationSettings.comment}
                onChange={(checked) =>
                  handleUpdateSettings({
                    notificationSettings: {
                      ...settings.notificationSettings,
              ...
              <Switch
                label="新提及"
                checked={settings.notificationSettings.mention}
                onChange={(checked) =>
                  handleUpdateSettings({
                    notificationSettings: {
                      ...settings.notificationSettings,
        ...
        <div className="p-6 space-y-6">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <Switch
                label="公开个人简介"
                checked={settings.privacySettings.showBio}
                onChange={(checked) =>
                  handleUpdateSettings({
                    privacySettings: {
                      ...settings.privacySettings,
              ...
              <Switch
                label="公开关注者"
                checked={settings.privacySettings.showFollowers}
                onChange={(checked) =>
                  handleUpdateSettings({
                    privacySettings: {
                      ...settings.privacySettings,
              ...
              <Switch
                label="公开关注中"
                checked={settings.privacySettings.showFollowing}
                onChange={(checked) =>
                  handleUpdateSettings({
                    privacySettings: {
                      ...settings.privacySettings,
