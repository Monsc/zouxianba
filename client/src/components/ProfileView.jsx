      ...
      >
        ...
        >
          ...
          <div className="px-4 pb-4">
            ...
            {user.bio && <p className="mb-4 whitespace-pre-wrap">{user.bio}</p>}
            ...
            <div className="flex gap-4 mb-4">
              <button onClick={() => handleUserListClick('following')} className="hover:underline">
                <span className="font-bold">{stats.following}</span>
                <span className="text-twitter-gray-500"> 关注中</span>
              </button>
              <button onClick={() => handleUserListClick('followers')} className="hover:underline">
                <span className="font-bold">{stats.followers}</span>
                <span className="text-twitter-gray-500"> 关注者</span>
              </button>
              <button onClick={() => handleUserListClick('posts')} className="hover:underline">
                <span className="font-bold">{stats.posts}</span>
                <span className="text-twitter-gray-500"> 帖子</span>
              </button>
              <button onClick={() => handleUserListClick('likes')} className="hover:underline">
            ...
            <div className="mt-4">
              {posts.length > 0 ? (
                posts.map(post => (
                  <div
                    key={post._id}
                    className="border-b border-twitter-gray-200 dark:border-twitter-gray-800 py-4"
                  >
                    {/* 帖子内容 */}
                  </div>
                ))
