...
const SearchPage = () => {
  ...
  const { q, type = 'all' } = navigate.location.search.slice(1).split('&').reduce((acc, param) => {
  ...
  const handleFollow = async (userId) => {
    ...
    try {
      ...
      setResults(results.map(result => 
        result._id === userId 
          ? { ...result, isFollowing: response.data.isFollowing }
          : result
      ));
                      ...
                      <div className="p-4">
                        ...
                        {result.images?.length > 0 && (
                          <div className={`mt-4 grid gap-2 ${
                            ...
                            result.images.length === 3 ? 'grid-cols-3' :
                      ...
                      <div className="px-4 py-3 border-t bg-gray-50">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-4">
                            ...
                            >
                              <svg className="w-5 h-5" fill={result.isLiked ? 'currentColor' : 'none'} stroke="currentColor" viewBox="0 0 24 24">
